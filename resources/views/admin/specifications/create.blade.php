    ...
    <form action="{{ route('specifications.store') }}" method="POST" class="specification-form">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" id="specification" name="specification" class="form-input" value="{{ old('specification') }}">
                @error('specification')
        ...
        <div class="form-footer">
            <button type="submit" class="add-btn">Create Specification</button>
